...
export default function TradingDashboard(){
  ...
  const pickMarketOverviewById=(id:string,nextMarket:Market)=>{if(id==="BTC"){changeMarket(nextMarket);return;}if(isMarketIndexId(id)){openIndexView(id);return;}changeMarket(nextMarket);};
