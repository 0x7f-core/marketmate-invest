  ...
  return createPortal(
    <>
      ...
      <style>{`
        ...
        .home-index-live-board .home-index-card{position:relative;min-width:0;min-height:190px;padding:16px 20px 12px;display:flex!important;flex-direction:column;align-items:stretch;gap:0;border:0;border-right:1px solid #edf0f2;border-bottom:1px solid #edf0f2;background:#fff;text-align:left;overflow:hidden}
        ...
        .home-index-name{display:block!important;color:#202428!important;padding-right:0;font-size:14px!important;font-weight:500!important;line-height:19px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .home-index-live-board .home-index-card>strong{display:block;margin-top:8px;color:#17191c;font-size:18px;font-weight:600;line-height:24px;letter-spacing:-.03em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .home-index-live-board .home-index-card>em{display:block;margin-top:5px;font-size:11px;font-weight:500;font-style:normal;line-height:16px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        ...
        .home-index-sparkline{display:block;width:100%;height:54px;margin-top:10px;overflow:visible}.home-index-sparkline.empty{background:linear-gradient(180deg,transparent 49%,#edf0f2 49.5%,#edf0f2 50.5%,transparent 51%)}
